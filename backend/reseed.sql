...
('Gabriel', 'Batistuta', 'Batigol', 'gabriel@test.com', '11111111', '1234', 'organizador', NOW()),
('Martin', 'Palermo', 'Titan', 'martin@test.com', '22222222', '1234', 'jugador', NOW()),
('Lionel', 'Messi', 'La Pulga', 'leo@test.com', '33333333', '1234', 'jugador', NOW()),
('Diego', 'Maradona', 'Pelusa', 'diego@test.com', '44444444', '1234', 'jugador', NOW()),
('Juan', 'Riquelme', 'Topo Gigio', 'juan@test.com', '55555555', '1234', 'jugador', NOW()),
('Julian', 'Alvarez', 'La Araña', 'julian@test.com', '66666666', '1234', 'jugador', NOW()),
('Enzo', 'Fernandez', 'Gardelito', 'enzo@test.com', '77777777', '1234', 'jugador', NOW()),
('Angel', 'Di Maria', 'Fideo', 'angel@test.com', '88888888', '1234', 'jugador', NOW()),
('Emiliano', 'Martinez', 'Dibu', 'dibu@test.com', '99999999', '1234', 'jugador', NOW()),
('Sergio', 'Aguero', 'Kun', 'kun@test.com', '10101010', '1234', 'jugador', NOW());
